...
const translation = {
  "EN": "Express Settings",
  "RU": "Экспресс настройки",
};

const ExpressSettings = () => {

  const [ { lang, theme }, dispatch ] = useStateContext();
  const [ { mode, skin }, dispatchSB ] = useStateSandbox();  

  return (
    <div className={style["express-settings"]}>
      <input type="checkbox" id="express-settings-panel" />
      <label htmlFor="express-settings-panel">
        ...
        <div className={style["express-panel"]}>
          ...
          <Representation {...{ mode, skin, dispatch: dispatchSB }} />
        </div>
      </label>
